<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom:0; background-color:cadetblue;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="" style = "color:white;"><i class = "fa fa-home fa-large" > </i><b>C_ELECTZ</b>-College Voting System</a>
            ...
            <ul class="nav navbar-top-links navbar-right">
			 ...
			 ?>
                ...
                <li class="dropdown">
					...
					<i class="fa fa-cog fa-spin fa-fw"></i>Project name: <?php echo $user_username = $user_row['firstname']." ".$user_row['lastname'];?>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-user fa-fw"></i> Admin Details<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="user.php"> <i class = "fa fa-users" ></i> View Admin</a>
                                </li>
                                <li>
